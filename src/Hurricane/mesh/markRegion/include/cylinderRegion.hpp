/*!
 * \file cylinderRegion.hpp
 * \brief Headers of the cylinder region of mesh.
...
namespace OpenHurricane {
    class cylinderRegion : public markRegion {
    private:
    ...
    public:
        declareClassName(cylinderRegion);

        cylinderRegion(const controller &cont);

        /*!\brief Destructor.*/
        inline virtual ~cylinderRegion() noexcept {}

        // Member functions

        hur_nodiscard inline const vector &Amax() const noexcept;
        hur_nodiscard inline const vector &Amin() const noexcept;
