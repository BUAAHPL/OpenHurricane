/*!
 * \file AUSM.hpp
 * \brief Headers of The advection upstream splitting method (AUSM) scheme.
 *        The subroutines and functions are in the <i>AUSM.cpp</i> file.
 * \author Rao Sihang
 * \version V2.0.0
 * \date 2022.05.02
 *
...
namespace OpenHurricane {
    ...
    /*!
     * \brief The class of AUSM scheme.
     */
    class AUSM : public upwindScheme {
    private:
    ...
    public:
        ...
        AUSM(const controller &cont, const runtimeMesh &mesh, flowModel &flow);

        /**\brief Destructor.*/
        virtual ~AUSM() noexcept {}
    };
