/*!
 * \file AUSMPWPlus.hpp
 * \brief Headers of AUSMPW+ scheme.
 *        The subroutines and functions are in the <i>AUSMPWPlus.cpp</i> file.
 * \author Rao Sihang
 * \version V2.0.0
 * \date 2022.05.02
 *
...
namespace OpenHurricane {
    ...
    /*!
     * \brief The class of AUSMPWPlus scheme.
     */
    class AUSMPWPlus : public upwindScheme {
    private:
        mutable realArray fp_;
        mutable realArray fluxR_;
    ...
    public:
        ...
        virtual void calcAS(const vector &vl, const vector &vr, const real hsl, const real hsr,
                            const real gamml, const real gammr, const vector &faceArea, real &al,
                            real &ar) const;
    ...
    public:
        ...
        AUSMPWPlus(const controller &cont, const runtimeMesh &mesh, flowModel &flow);

        /**\brief Destructor.*/
        virtual ~AUSMPWPlus() noexcept {}
    };
