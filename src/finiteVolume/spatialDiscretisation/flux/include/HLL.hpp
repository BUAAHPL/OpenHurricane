/*!
 * \file HLL.hpp
 * \brief Headers of HLL-Riemann scheme.
 *        The subroutines and functions are in the <i>HLL.cpp</i> file.
 * \author Rao Sihang
 * \version V2.0.0
 * \date 2022.05.02
 *
...
namespace OpenHurricane {
    ...
    /*!
     * \brief The class of HLL scheme.
     */
    class HLL : public upwindScheme {
    private:
    public:
        /**
    ...
    public:
        ...
        HLL(const controller &cont, const runtimeMesh &mesh, flowModel &flow);

        /**\brief Destructor.*/
        virtual ~HLL() noexcept {}
    };
