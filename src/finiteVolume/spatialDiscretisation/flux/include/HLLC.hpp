/*!
 * \file HLLC.hpp
 * \brief Headers of HLLC-Riemann scheme.
 *        The subroutines and functions are in the <i>HLLC.cpp</i> file.
 * \author Rao Sihang
 * \version V2.0.0
 * \date 2022.05.02
 *
...
namespace OpenHurricane {
    ...
    /*!
     * \brief The class of HLLC scheme.
     */
    class HLLC : public upwindScheme {
    private:
        mutable realArray ds_;
        mutable realArray uu_;

        bool lowMachCor_;
        bool enhancedShockStab_;
    ...
    public:
        ...
        HLLC(const controller &cont, const runtimeMesh &mesh, flowModel &flow);

        /**\brief Destructor.*/
        virtual ~HLLC() noexcept {}
    };
