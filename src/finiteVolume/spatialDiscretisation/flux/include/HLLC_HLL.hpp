/*!
 * \file HLLC_HLL.hpp
 * \brief Headers of HLLC_HLL-Riemann scheme.
 *        The subroutines and functions are in the <i>HLLC_HLL.cpp</i> file.
 * \author Rao Sihang
 * \version V2.0.0
 * \date 2022.05.02
 *
...
namespace OpenHurricane {
    ...
    /*!
     * \brief The class of HLLC_HLL scheme.
     */
    class HLLC_HLL : public upwindScheme {
    private:
        mutable realArray ds_;
        mutable realArray uul_;
        mutable realArray uur_;
        mutable realArray uu_;
        mutable realArray uhll_;
        mutable realArray uhllc_;
        mutable realArray fl_;
        mutable realArray fr_;
    ...
    public:
        ...
        HLLC_HLL(const controller &cont, const runtimeMesh &mesh, flowModel &flow);

        /**\brief Destructor.*/
        virtual ~HLLC_HLL() noexcept {}
    };

} // namespace OpenHurricane

#include "HLLC_HLL.inl"