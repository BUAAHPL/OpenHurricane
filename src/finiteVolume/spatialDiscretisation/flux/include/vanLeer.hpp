/*!
 * \file vanLeer.hpp
 * \brief Headers of van Leer flux-vector splitting scheme.
 *        The subroutines and functions are in the <i>vanLeer.cpp</i> file.
 * \author Rao Sihang
 * \version V2.0.0
 * \date 2022.05.02
 *
...
namespace OpenHurricane {
    ...
    /*!
     * \brief The class of van Leer scheme.
     */
    class vanLeer : public upwindScheme {
    private:
    protected:
        /**
    ...
    public:
        ...
        inline vanLeer() = delete;

        vanLeer(const controller &cont, const runtimeMesh &mesh, flowModel &flow);
        /**\brief Destructor.*/
        virtual ~vanLeer() noexcept {}
    };
