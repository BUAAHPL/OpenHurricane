...
class multilevelNestedDissectionByMetis : public reordering {
private:
    /*!\brief Disallow null constructor*/
    multilevelNestedDissectionByMetis() = delete;

    /*!\brief Disallow construct as copy*/
    multilevelNestedDissectionByMetis(
        const multilevelNestedDissectionByMetis &) = delete;
...
public:
    ...
    inline multilevelNestedDissectionByMetis(decomposingMeshByMetis &dcpMesh);

    /*!\brief Destructor.*/
    virtual ~multilevelNestedDissectionByMetis() noexcept {};
...
#include "multilevelNestedDissectionByMetis.inl"