/*!
 * \file EulerSpeciesSolverFluxJacobians.cpp
 * \brief The flux Jacobians of Euler species reacting Solver.
 * \author Rao Sihang
 * \version V2.0.0
 * \date 2022.05.02
 *
...
void OpenHurricane::EulerSpeciesSolver::Ac(const integer celli,
                                           const vector &normal, const real Vt,
...
void OpenHurricane::EulerSpeciesSolver::dpdq(const integer celli,
                                             const vector &normal,
                                             realArray &pq) const {
...
void OpenHurricane::EulerSpeciesSolver::Acdq(const integer celli,
                                             const vector &normal,
                                             const realArray &dq,
                                             realArray &adq) const {
    const real nx = normal.x();
