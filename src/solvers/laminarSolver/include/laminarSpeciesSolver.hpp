/*!
 * \file laminarSpeciesSolver.hpp
 * \brief Headers of laminar species transport Solver.
 *        The subroutines and functions are in the <i>laminarSpeciesSolver.cpp</i> file.
 * \author Rao Sihang
 * \version V2.0.0
 * \date 2022.05.02
 *
...
namespace OpenHurricane {
    /*!\brief The class of laminar species solver.*/
    class laminarSpeciesSolver : public solver {
    protected:
    ...
    public:
        declareClassName(laminarSpeciesSolver);


        laminarSpeciesSolver(iteration &iter, const runtimeMesh &mesh);

        /*!\brief Destructor.*/
        virtual ~laminarSpeciesSolver() noexcept;
    ...
    protected:
        mutable integerList *fzBoundStartPtr_;
...
#include "laminarSpeciesSolver.inl"