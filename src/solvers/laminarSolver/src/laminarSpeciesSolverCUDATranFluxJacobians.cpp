/*!
 * \file laminarSpeciesSolverCUDATranFluxJacobians.cpp
 * \brief The flux Jacobians of laminar species transport Solver using CUDA accelerating
...
#ifdef CUDA_PARALLEL
void OpenHurricane::laminarSpeciesSolverCUDATran::Ac(
...
void OpenHurricane::laminarSpeciesSolverCUDATran::dpdq(const integer celli,
                                                       const vector &normal,
                                                       realArray &pq) const {
...
void OpenHurricane::laminarSpeciesSolverCUDATran::Acdq(const integer celli,
                                                       const vector &normal,
                                                       const realArray &dq,
                                                       realArray &adq) const {
    const real nx = normal.x();
