/*!
 * \file laminarSpeciesSolverFluxJacobians.cpp
 * \brief The flux Jacobians of laminar species transport Solver.
 * \author Rao Sihang
 * \version V2.0.0
 * \date 2022.05.02
 *
...
void OpenHurricane::laminarSpeciesSolver::Ac(const integer celli,
                                             const vector &normal,
                                             const real Vt,
...
void OpenHurricane::laminarSpeciesSolver::dpdq(const integer celli,
                                               const vector &normal,
                                               realArray &pq) const {
...
void OpenHurricane::laminarSpeciesSolver::Acdq(const integer celli,
                                               const vector &normal,
                                               const realArray &dq,
                                               realArray &adq) const {
    const real nx = normal.x();
