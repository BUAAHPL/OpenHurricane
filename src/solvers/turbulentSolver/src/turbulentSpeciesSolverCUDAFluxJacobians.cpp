/*!
 * \file turbulentPerfectGasSolverCUDAFluxJacobians.cpp
 * \brief Flux Jacobians of turbulent species Solver.
 * \author Rao Sihang
 * \version V2.0.0
 * \date 2022.05.02
 *
...
void OpenHurricane::turbulentSpeciesSolverCUDA::Ac(const integer celli,
                                                   const vector &normal,
                                                   const real Vt,
...
void OpenHurricane::turbulentSpeciesSolverCUDA::dpdq(const integer celli,
                                                     const vector &normal,
                                                     realArray &pq) const {
...
void OpenHurricane::turbulentSpeciesSolverCUDA::Acdq(const integer celli,
                                                     const vector &normal,
                                                     const realArray &dq,
                                                     realArray &adq) const {
    const integer nsp = specTable().size();
