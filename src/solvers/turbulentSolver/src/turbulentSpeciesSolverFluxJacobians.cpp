/*!
 * \file turbulentPerfectGasSolverFluxJacobians.cpp
...
void OpenHurricane::turbulentSpeciesSolver::Ac(const integer celli,
                                               const vector &normal,
                                               const real Vt,
...
void OpenHurricane::turbulentSpeciesSolver::dpdq(const integer celli,
                                                 const vector &normal,
                                                 realArray &pq) const {
...
void OpenHurricane::turbulentSpeciesSolver::Acdq(const integer celli,
                                                 const vector &normal,
                                                 const realArray &dq,
                                                 realArray &adq) const {
    const integer nsp = specTable().size();
