 ...
 * \brief Header of chemically acticated bimolecular reaction rate.
 * \author Rao Sihang
 * \version V2.0.0
 * \date 2022.05.02
 *
...
namespace OpenHurricane {
    /**
     * \brief Chemically Activated Bimolecular Reactions.
     */
    class chemicallyActicatedBimolecularRR : public reactionRateTypes {
    private:
        // Private data
    ...
    public:
        declareClassName(chemicallyActicatedBimolecularRR);

        inline chemicallyActicatedBimolecularRR(const ArrheniusRR &k0, const ArrheniusRR &kinf,
        ...
        inline chemicallyActicatedBimolecularRR(const chemicallyActicatedBimolecularRR &other)
            : reactionRateTypes(other), k0_(other.k0_), kinf_(other.kinf_), F_((*other.F_).clone()),
              thirdBodyEfficiency_(other.thirdBodyEfficiency_) {}

        inline chemicallyActicatedBimolecularRR(const speciesList &sp, const controller &cont)
        ...
        inline virtual ~chemicallyActicatedBimolecularRR() noexcept {}

        hur_nodiscard virtual inline uniquePtr<reactionRateTypes> clone() const {
            return uniquePtr<reactionRateTypes>(new chemicallyActicatedBimolecularRR(*this));
        }

        hur_nodiscard virtual inline std::string type() const noexcept {
            return std::string("ChemicallyActicatedBimolecularReaction");
        }
