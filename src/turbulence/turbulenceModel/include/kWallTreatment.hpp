...
namespace OpenHurricane {
    ...
    class kWallTreatment : public realBoundary {
    public:
    ...
    public:
        ...
        kWallTreatment(const faceZone &fZ, geometryArray<real, cellMesh> &gf,
                       const controller &cont);

        /**\brief Construct from components.*/
        kWallTreatment(const kWallTreatment &bB);

        /*!\brief Destructor.*/
        virtual ~kWallTreatment() noexcept {}
