...
namespace OpenHurricane {
    ...
    class omegaNearWallTreatment : public realBoundary {
    public:
    ...
    public:
        ...
        omegaNearWallTreatment(const faceZone &fZ, geometryArray<real, cellMesh> &gf,
                               const controller &cont);

        /**\brief Construct from components.*/
        omegaNearWallTreatment(const omegaNearWallTreatment &bB);

        /*!\brief Destructor.*/
        virtual ~omegaNearWallTreatment() noexcept {}
