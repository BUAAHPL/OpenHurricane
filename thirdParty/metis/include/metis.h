...
/*--------------------------------------------------------------------------
 Specifies the width of the elementary data bcType that will hold information
...
/*--------------------------------------------------------------------------
 Specifies the data bcType that will hold floating-point style information.
...
#ifdef _WINDLL
#define METIS_API(bcType) __declspec(dllexport) bcType __cdecl
#elif defined(__cdecl)
#define METIS_API(bcType) bcType __cdecl
#else
...
//#ifdef HUR_DEBUG
//#pragma comment(lib,"src/thirdParty/metis/Windows/metisd.lib")
//#else
//#pragma comment(lib,"src/thirdParty/metis/Windows/metis.lib")
//#endif // HUR_DEBUG
